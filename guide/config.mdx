    ...
    themeConfig: {
        ...
        nav: [
            ...
            },
            {
                text: '#V_VERSION',
                items: [
                    {text: 'Release', link: 'https://github.com/DecisionToolkit/dsntk/releases/tag/#V_VERSION'},
                    {
                        text: 'Changelog',
                        link: 'https://github.com/DecisionToolkit/dsntk/blob/#V_VERSION/CHANGELOG.md'
                    }
                ]
            }
        ],
